...
4. **The inheritance.** The world does not reset, it REMEMBERS: the next character enters the same living campaign, where the fallen one's grave exists, their debts are collectible, their enemies are still angry, their companions are still grieving, and their reputation attaches to anyone who claims the connection. Offer the player their next character whenever they are ready - creation as usual, but seeded by a world that visibly carries their last life. Finding your own predecessor's story from the outside is one of the strongest experiences this game can produce; set it up, never force it.
